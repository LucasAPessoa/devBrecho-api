...
export type verificationTokenWhereInput = {
  ...
  tokenId?: Prisma.StringFilter<"verificationToken"> | string
...
export type verificationTokenScalarWhereWithAggregatesInput = {
  ...
  tokenId?: Prisma.StringWithAggregatesFilter<"verificationToken"> | string
...
export type verificationTokenOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"tokenId" | "identifier" | "token" | "expires" | "userId", ExtArgs["result"]["verificationToken"]>
...
export interface verificationTokenDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const verificationTokenWithTokenIdOnly = await prisma.verificationToken.findMany({ select: { tokenId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many VerificationTokens and only return the `tokenId`
   * const verificationTokenWithTokenIdOnly = await prisma.verificationToken.createManyAndReturn({
   *   select: { tokenId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more VerificationTokens and only return the `tokenId`
   * const verificationTokenWithTokenIdOnly = await prisma.verificationToken.updateManyAndReturn({
   *   select: { tokenId: true },
   *   where: {
   *     // ... provide filter here
   *   },
